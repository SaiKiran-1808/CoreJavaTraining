...
public class IO3_FileWriterExample {
    public static void main(String[] args) {
    	...
    	String filename = "D:\\CoreJAVA_Workspace\\CoreJAVA_Development\\src\\com\\evergent\\corejava\\io\\streams\\myexample.txt";
     
        String content = "Hello, World!\nWelcome to Java FileWriter example.: SAIKIRAN";
